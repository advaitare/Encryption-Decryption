...
public class Encode extends Decode
{
	public void codeencode()
{
		String s;
		int i=0,j=1,k;
		char reader;
		...
		s=sc.nextLine();
		int length = s.length();
		System.out.print("Enter Number Of Iterations (Above 1000 recommended) : ");
		k=sc.nextInt();
		while(j<=k)
		{
		i=0;
		...
		System.out.print("\n\n[WARNING] Please remember the number of iterations you used. If you forgot your iterations then all your information is lost.\n[NOTE] Copy your encoded message and store it securely.\n\n");
	}
}
